...
var options = {
  ...
  onUpdate: function (item, callback) {
    ...
    DanhSachCoVan()
    changvalue()
    if ((localStorage.getItem("userName") === $("#NguoiDatHen").val() ||
      ...
      if ($("#TrangThaiXuong").val() == "00 Có Hẹn") {
        ...
        $("#buttonDK").html("<button  type='button' class='btn btn-primary me-2' onclick='CapNhatHen()'>Cập Nhật!</button>")
      } else { $("#buttonSCC").html(""); $("#buttonDK").html("") }
...
function datadathen(r) {
  try {
    ...
    if ((r.NoiDungHen.toUpperCase()).indexOf("VIP") >= 0) { Kytu = "💶" }
